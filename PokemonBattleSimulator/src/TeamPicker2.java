/*This class is what is used to pick player 2's pokemon team
 * 
 * 
 */
...
public class TeamPicker2 extends JPanel implements MouseListener {
	
	private JFrame w;
	private static Pokemon player21;
	private static Pokemon player22;
	private static Pokemon player23;
	...
	//type class
	public TeamPicker2(JFrame window) {
	...
	public void paintComponent(Graphics g) {
		...
		g.setFont(big);
		g.drawString("Player 2", 800, 1045);
		g.setFont(font);
		...
		if(pokeNum ==0) {
			...
			g.drawString(player21.getName(),400, 1000);
			delete.draw(g, this);
		}else if(pokeNum == 2) {
			g.drawString(player21.getName(),400, 1000);
			g.drawString(player22.getName(),866, 1000);
			delete.draw(g, this);

		}else if(pokeNum == 3) {
			g.drawString(player21.getName(),400, 1000);
			g.drawString(player22.getName(),866, 1000);
			g.drawString(player23.getName(), 1332, 1000);
	...
	public static Pokemon getPlayer21() {
		return player21;
	}
	
	public static Pokemon getPlayer22() {
		return player22;
	}
	
	public static Pokemon getPlayer23() {
		return player23;
	}
}
